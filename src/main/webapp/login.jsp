...
<body>
	<header style="background-color: lavender; margin-top: -20px; height: 50px;color: #0000A0;">
		<center>
	...
	<div class="container" align="middle">
		...
		<div class="row mt-5">
			<form action="authenticate" method="post" align="middle">
				<div class="row m-5">
					<label class="col-md-5" for="name">UserId:</label> <input
						type="text" class="col-md-5" name="username"
						placeholder="Enter Username" required>
				</div>
				<div class="row m-5">
					<label class="col-md-5" for="name">Password:</label> <input
